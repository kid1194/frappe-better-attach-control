...
| `allowed_file_types` | Array of allowed file types (mimes) or extensions to upload. Prefix regex types with **$**.<br/><br/>- Example: `["image/*", "video/*", ".pdf", ".doc", "$audio/(wav|mp3|m4a)"]`<br/>- Default: `null` or `["image/*"]` |
